...
- [x] **Step 3: Write `frontend/src/components/layout/StatusPill.tsx`**
...
- [x] **Step 4: Write `frontend/src/components/layout/ErrorState.tsx`**
...
- [x] **Step 5: Write `frontend/src/components/layout/EmptyState.tsx`**
...
- [x] **Step 6: Write `frontend/src/components/layout/Pagination.tsx`**
...
- [x] **Step 7: Write `frontend/src/components/layout/Breadcrumbs.tsx`**
...
- [x] **Step 8: Write `frontend/src/components/layout/TopNav.tsx`**
...
- [x] **Step 9: Write `frontend/src/components/layout/AppShell.tsx`**
...
- [x] **Step 10: Write `frontend/src/app/providers.tsx`**
...
- [x] **Step 11: Write `frontend/src/app/router.tsx` (placeholder routes for now)**
...
- [x] **Step 12: Replace `frontend/src/main.tsx`, delete the scaffold's App files**
...
- [x] **Step 13: Run tests, typecheck, build**
...
- [x] **Step 3: Write `frontend/src/features/taxonomy/queries.ts`**
...
- [x] **Step 4: Write `frontend/src/features/taxonomy/TaxonomyCard.tsx`**
...
- [x] **Step 5: Write `frontend/src/routes/ProgramsPage.tsx`**
...
- [x] **Step 6: Write `frontend/src/routes/BranchesPage.tsx`**
...
- [x] **Step 7: Write `frontend/src/routes/SubjectsPage.tsx`**
...
- [x] **Step 8: Wire the three routes in `frontend/src/app/router.tsx`**
...
- [x] **Step 3: Write `frontend/src/features/notes/queries.ts`**
...
- [x] **Step 4: Write `frontend/src/features/notes/NoteCard.tsx`**
...
- [x] **Step 5: Write `frontend/src/features/notes/NoteFilters.tsx`**
...
- [x] **Step 6: Write `frontend/src/features/notes/NoteFileList.tsx`**
...
- [x] **Step 7: Write `frontend/src/routes/NoteDetailPage.tsx`**
...
- [x] **Step 8: Write `frontend/src/routes/SearchPage.tsx`**
...
- [x] **Step 9: Write `frontend/src/routes/SubjectNotesPage.tsx`**
...
- [x] **Step 3: Write `frontend/src/features/notes/upload.ts`**
...
- [x] **Step 5: Write `frontend/src/routes/UploadPage.tsx`**
...
- [x] **Step 3: Write `frontend/src/routes/MyUploadsPage.tsx`**
...
- [x] **Step 4: Write `frontend/src/routes/SettingsPage.tsx`**
...
- [x] **Step 5: Write the login and register pages**
...
- [x] **Step 3: Write `frontend/src/features/moderation/queries.ts`**
...
- [x] **Step 4: Write `frontend/src/features/moderation/ReviewDialog.tsx`**
...
- [x] **Step 5: Write `frontend/src/routes/ModerationPage.tsx`**
...
- [x] **Step 3: Write `frontend/src/features/users/queries.ts`**
...
- [x] **Step 4: Write `frontend/src/features/users/UserForm.tsx`**
...
- [x] **Step 5: Write `frontend/src/routes/UsersPage.tsx`**
...
- [x] **Step 7: Run the whole suite, typecheck, and build**
