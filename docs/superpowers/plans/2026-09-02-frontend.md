...
- [ ] **Step 3: Add the path alias to `frontend/tsconfig.app.json`**
...
- [ ] **Step 4: Write `frontend/src/index.css` — the design tokens**
...
- [ ] **Step 6: Write `frontend/src/lib/utils.ts`**
...
- [ ] **Step 8: Write `frontend/.env.example` and copy it**
...
- [ ] **Step 9: Add scripts to `frontend/package.json`**
...
- [ ] **Step 10: Write the token smoke test**
