...
- [ ] **Step 1: Write `frontend/src/test/msw.ts`**
...
- [ ] **Step 2: Replace `frontend/src/test/setup.ts`**
...
- [ ] **Step 3: Write `frontend/src/test/render.tsx`**
...
- [ ] **Step 6: Write `frontend/src/features/auth/AuthProvider.tsx`**
...
- [ ] **Step 7: Write `frontend/src/features/auth/useAuth.ts`**
...
- [ ] **Step 8: Write `frontend/src/features/auth/ProtectedRoute.tsx`**
...
- [ ] **Step 9: Write `frontend/src/features/auth/RoleGate.tsx`**
...
- [ ] **Step 10: Write `frontend/src/features/auth/LoginForm.tsx`**
...
- [ ] **Step 11: Write `frontend/src/features/auth/RegisterForm.tsx`**
