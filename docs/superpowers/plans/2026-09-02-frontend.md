...
- [ ] **Step 1: Write the failing test for branches**
...
- [ ] **Step 3: Implement `backend/src/modules/branches/branches.service.ts`**
...
- [ ] **Step 4: Implement `backend/src/modules/branches/branches.controller.ts`**
...
- [ ] **Step 5: Replace `backend/src/modules/branches/branches.routes.ts` entirely**
...
- [ ] **Step 7: Write the failing test for subjects**
...
- [ ] **Step 9: Implement `backend/src/modules/subjects/subjects.service.ts`**
...
- [ ] **Step 10: Implement `backend/src/modules/subjects/subjects.controller.ts`**
...
- [ ] **Step 11: Replace `backend/src/modules/subjects/subjects.routes.ts` entirely**
...
- [ ] **Step 13: Append the failing test for note files**
...
- [ ] **Step 15: Append `listNoteFiles` to `backend/src/modules/notes/notes.service.ts`**
...
- [ ] **Step 16: Append `listFiles` to `backend/src/modules/notes/notes.controller.ts`**
...
- [ ] **Step 17: Add the route in `backend/src/modules/notes/notes.routes.ts`**
...
- [ ] **Step 18: Run the full backend suite and typecheck**
