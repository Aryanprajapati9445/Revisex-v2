...
export function TaxonomyCard({ to, code, name, meta }: { to: string; code: string; name: string; meta?: string }) {
  return (
    <Card asChild className="group hover:-translate-y-0.5 hover:shadow-floating">
      <Link to={to}>
        <div className="flex items-center justify-between">
          <span className="flex size-8 items-center justify-center rounded-control bg-accent text-accent-foreground">
